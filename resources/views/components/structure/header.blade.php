<div class="container">
    <div class="row">
        <div class="col d-flex flex-row align-items-center justify-content-between pt-3">
            ...
            <nav id="header-right" class="d-flex flex-row align-items-center">
                <button type="button" class="btn btn-danger me-2">Admin</button>
                <button type="button" class="btn btn-primary me-2">My Stats</button>
